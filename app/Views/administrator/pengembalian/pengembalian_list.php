                            ...
                            <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($PageAttribute['parent'] . '/index?sortcolumn=' . base64_encode('id_divisi') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stretched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                            ...
                                            <td colspan="11">
                                                <div class="row">
                                                    <div class="col-lg-12 text-center">
                                                        <h4><strong><a href="<?php echo (base_url('administrator/Penjualan/index?keyword='.$value->id_penjualan)); ?>"><?php echo ($value->id_penjualan); ?></a></strong></h4>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
