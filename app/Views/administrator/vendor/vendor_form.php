                ...
                <div class="x_content">
                    ...
                    <form action="<?php echo $action ?>" method="post">
                        <div class="form-group">
                            <label for="id">ID Vendor</label>&nbsp;<span class="<?php echo session()->getFlashdata("ci_flash_message_id_type"); ?>"><small><?php echo session()->getFlashdata("ci_flash_message_id"); ?></small></span>
                        ...
                        <div class="form-group">
                            <label for="nama_vendor">Nama Vendor</label>&nbsp;<span class="<?php echo session()->getFlashdata("ci_flash_message_nama_vendor_type"); ?>"><small><?php echo session()->getFlashdata("ci_flash_message_nama_vendor"); ?></small></span>
                            <input type="text" class="form-control" autocomplete="on" name="nama_vendor" id="nama_vendor" maxlength="255" placeholder="Nama Vendor/Suplier" value="<?php echo $data->nama_vendor; ?>" required="true" />
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" autocomplete="on" name="kota" id="kota" maxlength="100" placeholder="Kota Vendor/Suplier" value="<?php echo $data->kota; ?>" required="true" />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" autocomplete="on" name="telepon" id="telepon" maxlength="50" placeholder="Telepon Vendor/Suplier" value="<?php echo $data->telepon; ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
