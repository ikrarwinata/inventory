                ...
                <div class="x_content">
                    ...
                    <table class="table table-light table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th width="15%">Nama Divisi</th><td>:  <?php echo $data->nama_divisi; ?></td>
                            </tr>
                            <tr>
                                <th width="15%">Kota</th><td>:  <?php echo $data->kota; ?></td>
                            </tr>
                            <tr>
                                <th width="15%">Alamat</th><td>:  <?php echo $data->alamat; ?></td>
                            </tr>
                            <tr>
                                <th width="15%">Telepon</th><td>:  <?php echo $data->telepon; ?></td>
                            </tr>
                            <tr>
