...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-reply"></i>&nbsp;<?php echo $PageAttribute["title"]; ?></h3>
        </div>
    </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($PageAttribute['parent'].'/index?sortcolumn='.base64_encode('invoice_keys').'&sortorder='.($sortorder=='ASC'?'DESC':'ASC')); ?>" class="stretched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                    <?php if ($sortcolumn=="invoice_keys"): ?>
                                                        <i class="fas fa-sort-alpha-<?php echo($sortorder=='DESC'?'down':'up'); ?>"></i>&nbsp;
                                                    <?php endif ?>Invoice No.
                                                </a>
                                            </th>
                                            <th>Qty</th>
                                            <th>&nbsp;</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">INV<?php echo str_repeat("0", (4 - strlen($value->invoice_keys))) . $value->invoice_keys ?></td>
                                            <td>
                                                <?php echo ($value->quantity); ?>
                                            </td>
                                            <td>
                                                <span class="float-right">
                                                    <a type="button" class="btn btn-sm btn-primary" href="<?php echo base_url($PageAttribute['parent'].'/read/'.$value->invoice_keys )?>" title="<?php echo(lang('Default.Tooltips.Read', [], $PageAttribute['locale'])) ?>"><i class="fa fa-eye fa-lg"></i></a>
                                                    <a type="button" class="btn btn-sm btn-danger" href="<?php echo base_url($PageAttribute['parent'].'/delete/'.$value->invoice_keys )?>" onclick="javascript: return confirm('<?php echo(lang('Promp.Delete', [], $PageAttribute['locale'])) ?>')" title="<?php echo(lang('Default.Tooltips.Delete', [], $PageAttribute['locale'])) ?>"><i class="fa fa-trash fa-lg"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
