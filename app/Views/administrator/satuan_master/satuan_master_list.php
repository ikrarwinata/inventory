                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($PageAttribute['parent'] . '/index?sortcolumn=' . base64_encode('nama_satuan') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stretched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                    <?php if ($sortcolumn == "nama_satuan") : ?>
                                                        <i class="fa fa-sort-<?php echo ($sortorder == 'DESC' ? 'down' : 'up'); ?>"></i>&nbsp;
                                                        <?php endif ?>Nama Satuan
                                                </a>
                                            </th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo formatNumber($value->total_master) ?></td>
                                            <td>
