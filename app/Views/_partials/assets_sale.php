                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" autocomplete="off" value="<?php echo (formatNumber($data->harga)); ?>" disabled />
                            <input type="hidden" value="<?php echo ($data->harga); ?>" id="harga"/>
                        </div>
                    </div>
