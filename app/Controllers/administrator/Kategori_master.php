...
class Kategori_master extends BaseController
{
    /**
     * Class constructor.
     */ 
    ...
    {
        $this->model = new Kategori_master_model(); //Set Default Models Of this Controller
    ...
    {
        return  [
            'parent' => 'administrator/Kategori_master',
            'title' => 'Kategori',
            'subtitle' => array(
                'Kategori',
            ),
    ...
    public function index()
    {
        ...
        $this->PageData["title"] = lang("Text.Category", [], $this->PageData['locale']);
        $this->PageData["subtitle"] = [lang("Text.Category", [], $this->PageData['locale'])];

        $page = $this->request->getGet("page");
        $page = $page<=0?1:$page;
        $keyword = $this->request->getGet("keyword");
        $totalrecord = $this->model->get_data($keyword)->countAllResults();
        $this->model->select("kategori_master.*, COUNT(master.id) AS total_master");
        $this->model->join("master", "kategori_master.id = master.kategori", "left");
        $this->model->groupBy("kategori_master.id");
        $data = [
        ...
        return view('administrator/kategori_master/kategori_master_list', $data);
        //endindex
    }
    ...
    {
        $this->PageData['title'] = lang("Text.CreateCategory", [], $this->PageData['locale']);
        ...
        return view('administrator/kategori_master/kategori_master_form', $data);
    }
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData['title'] = lang("Text.UpdateCategory", [], $this->PageData['locale']);
        $this->PageData['subtitle'] = array(
            $this->PageData['title']
        );
        ...
        $data = [
            'data' => (object) [
                ...
                'nama_kategori' => set_value('nama_kategori', $dataFind->nama_kategori),
            ],
    ...
    private function is_request_valid(){
        ...
        $this->validation->setRules([
            'nama_kategori' => 'trim|required|max_length[100]',
        ]);
