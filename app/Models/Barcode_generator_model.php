...
class Barcode_generator_model extends Model
{
    protected $table      = 'barcode_generator';
    ...
    protected $allowedFields = ['id', 'judul', 'barcode_text'];
